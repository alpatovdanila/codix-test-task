    ...
    return (
        <div className={cn(previewStyles.CarPreview, cardStyles.CarCard)}>
            <div className={cn('row', cardStyles.Row)}>
                ...
                <div className="col">
                    <div className="row">
                        <div className="col-auto"><Color color={car.color}/></div>
                        <div className={cn('col', cardStyles.Price)}><Price price={car.price}/></div>
                    </div>
                </div>
            </div>
            ...
            <div className={cn('row', 'align-items-center',  cardStyles.Row)}>
                <div className="col">
                    <div className="row">
                        ...
                        <div className={cn('col', cardStyles.Status)}>{getCarStatusLabel(car.status)}</div>
                    </div>
                </div>
                <div className={cn('col', cardStyles.Actions)}>
                    <button className={previewStyles.Button} onClick={onDelete}>Удалить</button>
                </div>
            </div>
        </div>
    )
